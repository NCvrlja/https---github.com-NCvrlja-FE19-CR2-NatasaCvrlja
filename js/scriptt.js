...
// function sortCards(){
//     let sortedCards = Array.from(tasks).sort((a, b) => {
//         let aNumber = parseInt(a.querySelector(".priors").textContent);
//         let bNumber = parseInt(b.querySelector(".priors").textContent);
//         return aNumber - bNumber;
//     })
...
// }
//  cards.forEach(card => {
//     let number = card.querySelector(".priors");
//     let value = parseInt(number.textContent);

// document.getElementsByClassName("priors").addEventListener("click", () => {
//     if(value < 5){
//         value++;
//         number.textContent = value;
//         number.parentElement.classList.remove(getColorClass(value -1));
//         number.parentElement.classList.add(getColorClass(value));
//     }
// });})
